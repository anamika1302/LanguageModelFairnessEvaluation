...
def train(args):
  ...
  if resuming:
    ...
    if args.train_from_scratch:
      ...
      model = model_type.from_pretrained(args.model_name,return_dict=False)
  ...
  if args.eval_only:
    ...
    for i, eval_batch in enumerate(eval_dataloader):
      print("loading data from eval data loader")
      with torch.no_grad():
    ...
    counter1 = 0
    while True:
      print("training epoch: ",counter1+1 )
...
if __name__ == '__main__':
  ...
  parser.set_defaults(
      seed=1,
      wandb=True,
      experiment_name = "legal10k",
      train_dir = 'train',
      examples_dir = '/media/anamika/DATA/WPI_COURSES/NLP-DR/ilm/data/char_masks/legal_data',
